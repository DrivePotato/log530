 ...
 * Description: Fichier principal contenant les fonctionnalitÈs de conversions. Ce fichier a ÈtÈ automatiquement
 * 				gÈnÈrÈ grace ‡ un logiciel de convertisseur de langage. Les erreurs de compilations ont ÈtÈ 
 * 				corrigÈs. Le code puant a ÈtÈ identifiÈ et inscrit dans le rapport de laboratoire.
 */
...
public class GlobalMembers
{
	...
	public static void menu_seleccion()
	{
		...
		System.out.print("\nEscriba la cantidad, despu√©s el n√∫mero correspondiente a la unidad que quiere convertir");
		...
		// La variable resultado est populÈe dans une des mÈthodes de menu_conversion
